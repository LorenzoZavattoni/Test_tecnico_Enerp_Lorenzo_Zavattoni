    ...
    <div class="container mx-auto my-4">
        <div class="flex justify-center">
            <div class="w-full md:w-3/4 lg:w-1/2">
                <form class="p-3 shadow-md rounded-lg my-3 bg-white" method="post" action="{{ route('storePerson') }}">
                    @csrf

                    <div class="mb-3">
                        <label for="InputName" class="text-sm mb-1 font-medium">Nome</label>
                        <input name="nameP" type="text" value="{{old('nameP')}}" class="w-full rounded-md border-2 pl-2 py-1 placeholder:text-gray-400 @error('nameP') border-red-500 @enderror" placeholder="Mario" id="InputName" aria-describedby="nameHelp">
                        @error('nameP')
                    ...
                    <div class="mb-3">
                        ...
                        <input name="surnameP" type="text" value="{{old('surnameP')}}" class="w-full rounded-md border-2 pl-2 py-1 placeholder:text-gray-400 @error('surnameP') border-red-500 @enderror" placeholder="Rossi" id="InputSurname" aria-describedby="surnameHelp">
                        @error('surnameP')
                        <div class="text-red-500 text-xs mt-1">{{ $message }}</div>
                        @enderror
                    </div>
